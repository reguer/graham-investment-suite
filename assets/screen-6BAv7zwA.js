...
`.trim();function ge(e){return e.split(`
`).map(a=>{const[t,n,o,r,s]=a.split("|");return{rawTicker:t,ticker:t,yahooSymbol:n,companyName:o,sector:r||"Sin sector",industry:s||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:F,validationStatus:"validated_yahoo_mx"}})}function fe(e){const a=new Map;for(const t of e){const n=t.ticker.toUpperCase();a.has(n)||a.set(n,t)}return[...a.values()]}const V=ge(Ce),Y=fe([...q.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:F,priority:"requested"})),...V]),L={sourceDate:F,requestedCount:q.length,bmvSicCount:V.length,totalCount:Y.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},W={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function Ie(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const Q=pe.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:Ie(e)})),Te=new Map(Q.map(e=>[e.ticker.toUpperCase(),e]));function ve(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function xe(e=fetch,a="/"){try{const t=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!t.ok)throw new Error(`No se pudo cargar companies.json: ${t.status}`);const n=await t.json();return Array.isArray(n)?n.map(ve):[]}catch{return[]}}function Ee(e){const a=new Map;for(const t of e)for(const n of t){const o=n.ticker.toUpperCase();a.set(o,{...a.get(o)||{},...n})}return[...a.values()]}function be(e=[]){const a=Ee([Y,e]),t=a.map(r=>{var u,c,l,y,m;const s=Te.get(r.ticker.toUpperCase());return s?{...r,...s,yahooSymbol:s.yahooSymbol||s.ticker,market:s.market||"US",validationStatus:r.validationStatus||"manual_snapshot"}:r.analysisStatus==="analyzed"?{...r,yahooSymbol:r.yahooSymbol||r.ticker,market:r.market||"US",watchReason:r.watchReason||r.notes||"Analisis Graham automatico desde export publico.",tags:(u=r.tags)!=null&&u.length?r.tags:["sec-auto-analysis"]}:String(r.analysisStatus||"").startsWith("analysis_")?{...r,yahooSymbol:r.yahooSymbol||r.ticker,watchReason:r.watchReason||r.notes||"No se pudo completar el analisis automatico.",tags:(c=r.tags)!=null&&c.length?r.tags:["analysis-review"]}:r.analysisStatus==="index_reference"||r.analysisStatus==="market_reference"||r.validationStatus==="index_reference"||r.validationStatus==="market_reference"||(l=r.tags)!=null&&l.includes("index_reference")||(y=r.tags)!=null&&y.includes("market_reference")||["INDEX","ETF","FUTURE"].includes(String(r.quoteType||"").toUpperCase())?{...r,yahooSymbol:r.yahooSymbol||r.ticker,watchReason:r.watchReason||r.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(m=r.tags)!=null&&m.length?r.tags:["market_reference"]}:{...r,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[r.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),n=new Set(a.map(r=>r.ticker.toUpperCase())),o=Q.filter(r=>!n.has(r.ticker.toUpperCase()));return[...t,...o]}function Ae(e,a=[]){const t=a.map(n=>n.lastPriceUpdatedAt||n.lastPriceDate||n.sourceDate).filter(Boolean).sort((n,o)=>String(o).localeCompare(String(n)))[0]||L.sourceDate;return{...L,publicExportCount:a.length,analyzedCount:e.filter(n=>n.analysisStatus==="analyzed").length,referenceCount:e.filter(n=>n.analysisStatus==="index_reference"||n.analysisStatus==="market_reference"||n.validationStatus==="index_reference"||n.validationStatus==="market_reference"||["INDEX","ETF","FUTURE"].includes(String(n.quoteType||"").toUpperCase())).length,pendingCount:e.filter(n=>n.analysisStatus!=="analyzed"&&n.analysisStatus!=="index_reference"&&n.analysisStatus!=="market_reference"&&n.validationStatus!=="index_reference"&&n.validationStatus!=="market_reference").length,totalCount:e.length,dataUpdatedAt:t}}function Xe(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function Oe(e){const a=new Set;for(const t of e)for(const n of Xe(t.tags))a.add(n);return[...a].sort((t,n)=>t.localeCompare(n))}function qe(e){const a=new Set;for(const t of e){const n=String(t.sector||"").trim();n&&a.add(n)}return[...a].sort((t,n)=>t.localeCompare(n))}const K=[],ke=be(K);Ae(ke,K);const Pe=["pe","pb","debtRatio","currentRatio","fcf"];function z(e){return re(le({sector:e.sector,industry:e.industry,sicCode:e.sicCode}))}function j(e){const a=new Set(z(e).omit||[]);return a.has("current")&&a.has("debt")}function I(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function Re(e,a=e.price){if(!De(e))return null;const t=e.price/e.pe,n=e.hasNegativeEquity===!0,o=n?null:e.pb?e.price/e.pb:null,r=a/t,s=o!==null&&o>0?a/o:null,u=r!==null&&s!==null?r*s:null,c=ee(t,o),l=t*20,y=o!==null&&o>0?o*2:null,m=ae({grahamFormula:c,pricePe20:l,pricePb2:y});return{pe:r,pb:s,pePb:u,hasNegativeEquity:n||null,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:e.epsGrowing??null,roe:e.roe??null,roa:e.roa??null,tie:e.tie??null,epsAdj:t,bvps:o,price:a,grahamFormula:c,pricePe20:l,pricePb2:y,maxDefensivePrice:m,distanceToDefensive:m>0?(a-m)/m:null,marginOfSafety:te(c,a)}}function De(e){return e.hasNegativeEquity?I(e.price)&&I(e.pe)&&I(e.currentRatio):[e.price,e.pe,e.pb].every(I)?j(e)?!0:I(e.debtRatio)&&I(e.currentRatio):!1}function Ne(e){return e.hasNegativeEquity?["pe","currentRatio","fcf"].filter(a=>I(e[a])).length:Pe.filter(a=>I(e[a])).length}function Be(e,a=null,t=W){const n=(a==null?void 0:a.price)??e.lastPrice??e.price;if(Fe(e))return E({...e,quote:a,livePrice:n??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});const o=Ne(e),r=j(e)?2:3;if(o<r)return e.validationStatus==="yahoo_model_rejected"?E({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Rechazada por modelo Graham defensivo con datos parciales no comparables."},alertLevel:"watch",alertLabel:e.classificationLabel||"Rechazada por modelo",closeToDefensive:!1,near:!1}):E({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const s=Re(e,n);if(!s)return e.analysisStatus==="analyzed"?E({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?E({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):E({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const u=z(e),c=oe(s,u),l=new Set(u.omit||[]),y=u.useTangibleBook?s.pbTangible:s.pb,m=u.useTangibleBook?s.pePbTangible:s.pePb,C=(R,T,B)=>R||I(T)&&B,k=s.hasNegativeEquity?!1:C(l.has("pePb"),m,m<=t.nearPePb)&&C(l.has("pe"),s.pe,s.pe<=t.nearPe)&&C(l.has("pb"),y,y<=t.nearPb)&&C(l.has("debt"),s.debtRatio,s.debtRatio<t.nearDebtRatio)&&C(l.has("current"),s.currentRatio,s.currentRatio>=t.nearCurrentRatio)&&s.epsAllPositive===!0,f=!s.hasNegativeEquity&&s.distanceToDefensive!==null&&s.distanceToDefensive<=t.grahamDistancePct;let M="watch",S="En observacion";c.id==="graham_approved"?(M="approved",S="Aprobada Graham"):(k||f)&&(M="near",S="Cerca de aprobar");const P=M==="approved"?c.reason:ye(s,u);return E({...e,quote:a,livePrice:n,ratios:s,classification:c,sectorProfileId:u.id,alertLevel:M,alertLabel:S,watchReason:P,closeToDefensive:f,near:k})}function Ve(e,a={},t=W){return e.map(n=>Be(n,a[n.ticker]??null,t)).sort((n,o)=>{const r={approved:0,near:1,watch:2,reference:3,pending:4};return r[n.alertLevel]!==r[o.alertLevel]?r[n.alertLevel]-r[o.alertLevel]:!n.ratios||!o.ratios?n.ticker.localeCompare(o.ticker):n.ratios.pePb-o.ratios.pePb})}function Ye(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function Fe(e){var a,t;return e.analysisStatus==="index_reference"||e.analysisStatus==="market_reference"||e.validationStatus==="index_reference"||e.validationStatus==="market_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||((t=e.tags)==null?void 0:t.includes("market_reference"))||["INDEX","ETF","FUTURE"].includes(String(e.quoteType||"").toUpperCase())}function E(e){const a=he(e),t=Se({...e});return{...e,systemStatus:a,score:t}}export{X as D,He as M,re as a,Ve as b,oe as c,le as d,be as e,Ye as f,ee as g,xe as h,Ae as i,Oe as j,qe as k,we as l,Xe as n,_e as p,Le as s};
