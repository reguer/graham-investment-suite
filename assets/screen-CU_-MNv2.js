...
`).map(a=>{const[i,r,t,n,o]=a.split("|");return{rawTicker:i,ticker:i,yahooSymbol:r,companyName:t,sector:n||"Sin sector",industry:o||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:X,validationStatus:"validated_yahoo_mx"}})}function x(e){const a=new Map;for(const i of e){const r=i.ticker.toUpperCase();a.has(r)||a.set(r,i)}return[...a.values()]}const T=w(_),A=x([...h.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:X,priority:"requested"})),...T]),V={sourceDate:X,requestedCount:h.length,bmvSicCount:T.length,totalCount:A.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},P={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function W(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const D=H.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:W(e)})),K=new Map(D.map(e=>[e.ticker.toUpperCase(),e]));function Y(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function le(e=fetch,a="/"){try{const i=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!i.ok)throw new Error(`No se pudo cargar companies.json: ${i.status}`);const r=await i.json();return Array.isArray(r)?r.map(Y):[]}catch{return[]}}function z(e){const a=new Map;for(const i of e)for(const r of i){const t=r.ticker.toUpperCase();a.set(t,{...a.get(t)||{},...r})}return[...a.values()]}function q(e=[]){const a=z([A,e]),i=a.map(n=>{var p,S,d,u,M;const o=K.get(n.ticker.toUpperCase());return o?{...n,...o,yahooSymbol:o.yahooSymbol||o.ticker,market:o.market||"US",validationStatus:n.validationStatus||"manual_snapshot"}:n.analysisStatus==="analyzed"?{...n,yahooSymbol:n.yahooSymbol||n.ticker,market:n.market||"US",watchReason:n.watchReason||n.notes||"Analisis Graham automatico desde export publico.",tags:(p=n.tags)!=null&&p.length?n.tags:["sec-auto-analysis"]}:String(n.analysisStatus||"").startsWith("analysis_")?{...n,yahooSymbol:n.yahooSymbol||n.ticker,watchReason:n.watchReason||n.notes||"No se pudo completar el analisis automatico.",tags:(S=n.tags)!=null&&S.length?n.tags:["analysis-review"]}:n.analysisStatus==="index_reference"||n.analysisStatus==="market_reference"||n.validationStatus==="index_reference"||n.validationStatus==="market_reference"||(d=n.tags)!=null&&d.includes("index_reference")||(u=n.tags)!=null&&u.includes("market_reference")||["INDEX","ETF","FUTURE"].includes(String(n.quoteType||"").toUpperCase())?{...n,yahooSymbol:n.yahooSymbol||n.ticker,watchReason:n.watchReason||n.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(M=n.tags)!=null&&M.length?n.tags:["market_reference"]}:{...n,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[n.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),r=new Set(a.map(n=>n.ticker.toUpperCase())),t=D.filter(n=>!r.has(n.ticker.toUpperCase()));return[...i,...t]}function Q(e,a=[]){return{...V,publicExportCount:a.length,analyzedCount:e.filter(i=>i.analysisStatus==="analyzed").length,referenceCount:e.filter(i=>i.analysisStatus==="index_reference"||i.validationStatus==="index_reference").length,pendingCount:e.filter(i=>i.analysisStatus!=="analyzed"&&i.analysisStatus!=="index_reference").length,totalCount:e.length}}function j(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function ue(e){const a=new Set;for(const i of e)for(const r of j(i.tags))a.add(r);return[...a].sort((i,r)=>i.localeCompare(r))}const b=[],J=q(b);Q(J,b);const Z=["pe","pb","debtRatio","currentRatio","fcf"],$=["Financial Services","Real Estate","Insurance"];function E(e){const a=String(e.sector||"");return $.some(i=>a===i||a.startsWith(i+" /")||a.startsWith(i+"/"))}function y(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function ee(e,a=e.price){if(!ae(e))return null;const i=e.price/e.pe,r=e.price/e.pb,t=a/i,n=a/r,o=t*n,p=i>0&&r>0?Math.sqrt(22.5*i*r):null,S=i*20,d=r*2,u=Math.min(p,S,d);return{pe:t,pb:n,pePb:o,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:e.epsGrowing??null,roe:e.roe??null,roa:e.roa??null,tie:e.tie??null,epsAdj:i,bvps:r,price:a,grahamFormula:p,pricePe20:S,pricePb2:d,maxDefensivePrice:u,distanceToDefensive:u>0?(a-u)/u:null,marginOfSafety:a>0?(p-a)/a:null}}function ae(e){return[e.price,e.pe,e.pb].every(y)?E(e)?!0:y(e.debtRatio)&&y(e.currentRatio):!1}function ie(e){return Z.filter(a=>y(e[a])).length}function ne(e,a=null,i=P){const r=(a==null?void 0:a.price)??e.lastPrice??e.price;if(re(e))return m({...e,quote:a,livePrice:r??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});const t=ie(e),n=E(e)?2:3;if(t<n)return e.validationStatus==="yahoo_model_rejected"?m({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Rechazada por modelo Graham defensivo con datos parciales no comparables."},alertLevel:"watch",alertLabel:e.classificationLabel||"Rechazada por modelo",closeToDefensive:!1,near:!1}):m({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const o=ee(e,r);if(!o)return e.analysisStatus==="analyzed"?m({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?m({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):m({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const p=G(o),d=E(e)?o.pePb<=i.nearPePb&&o.pe<=i.nearPe&&o.pb<=i.nearPb&&o.epsAllPositive===!0:o.pePb<=i.nearPePb&&o.pe<=i.nearPe&&o.pb<=i.nearPb&&o.debtRatio<i.nearDebtRatio&&o.currentRatio>=i.nearCurrentRatio&&o.epsAllPositive===!0,u=o.distanceToDefensive!==null&&o.distanceToDefensive<=i.grahamDistancePct;let M="watch",f="En observacion";return p.id==="graham_approved"?(M="approved",f="Aprobada Graham"):(d||u)&&(M="near",f="Cerca de aprobar"),m({...e,quote:a,livePrice:r,ratios:o,classification:p,alertLevel:M,alertLabel:f,closeToDefensive:u,near:d})}function pe(e,a={},i=P){return e.map(r=>ne(r,a[r.ticker]??null,i)).sort((r,t)=>{const n={approved:0,near:1,watch:2,reference:3,pending:4};return n[r.alertLevel]!==n[t.alertLevel]?n[r.alertLevel]-n[t.alertLevel]:!r.ratios||!t.ratios?r.ticker.localeCompare(t.ticker):r.ratios.pePb-t.ratios.pePb})}function de(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function re(e){var a,i;return e.analysisStatus==="index_reference"||e.analysisStatus==="market_reference"||e.validationStatus==="index_reference"||e.validationStatus==="market_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||((i=e.tags)==null?void 0:i.includes("market_reference"))||["INDEX","ETF","FUTURE"].includes(String(e.quoteType||"").toUpperCase())}function m(e){return{...e,systemStatus:O(e)}}export{se as M,de as a,q as b,G as c,Q as d,ue as e,le as f,ce as l,j as n,pe as s};
