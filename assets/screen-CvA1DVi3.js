...
`).map(a=>{const[n,r,o,i,t]=a.split("|");return{rawTicker:n,ticker:n,yahooSymbol:r,companyName:o,sector:i||"Sin sector",industry:t||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:T,validationStatus:"validated_yahoo_mx"}})}function de(e){const a=new Map;for(const n of e){const r=n.ticker.toUpperCase();a.has(r)||a.set(r,n)}return[...a.values()]}const B=pe(ue),G=de([...N.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:T,priority:"requested"})),...B]),Me={sourceDate:T,requestedCount:N.length,bmvSicCount:B.length,totalCount:G.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},L={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function me(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const U=oe.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:me(e)})),Ce=new Map(U.map(e=>[e.ticker.toUpperCase(),e]));function Se(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function Be(e=fetch,a="/"){try{const n=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!n.ok)throw new Error(`No se pudo cargar companies.json: ${n.status}`);const r=await n.json();return Array.isArray(r)?r.map(Se):[]}catch{return[]}}function ye(e){const a=new Map;for(const n of e)for(const r of n){const o=r.ticker.toUpperCase();a.set(o,{...a.get(o)||{},...r})}return[...a.values()]}function fe(e=[]){const a=ye([G,e]),n=a.map(i=>{var l,s,c,M,d;const t=Ce.get(i.ticker.toUpperCase());return t?{...i,...t,yahooSymbol:t.yahooSymbol||t.ticker,market:t.market||"US",validationStatus:i.validationStatus||"manual_snapshot"}:i.analysisStatus==="analyzed"?{...i,yahooSymbol:i.yahooSymbol||i.ticker,market:i.market||"US",watchReason:i.watchReason||i.notes||"Analisis Graham automatico desde export publico.",tags:(l=i.tags)!=null&&l.length?i.tags:["sec-auto-analysis"]}:String(i.analysisStatus||"").startsWith("analysis_")?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"No se pudo completar el analisis automatico.",tags:(s=i.tags)!=null&&s.length?i.tags:["analysis-review"]}:i.analysisStatus==="index_reference"||i.analysisStatus==="market_reference"||i.validationStatus==="index_reference"||i.validationStatus==="market_reference"||(c=i.tags)!=null&&c.includes("index_reference")||(M=i.tags)!=null&&M.includes("market_reference")||["INDEX","ETF","FUTURE"].includes(String(i.quoteType||"").toUpperCase())?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(d=i.tags)!=null&&d.length?i.tags:["market_reference"]}:{...i,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[i.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),r=new Set(a.map(i=>i.ticker.toUpperCase())),o=U.filter(i=>!r.has(i.ticker.toUpperCase()));return[...n,...o]}function Ie(e,a=[]){return{...Me,publicExportCount:a.length,analyzedCount:e.filter(n=>n.analysisStatus==="analyzed").length,referenceCount:e.filter(n=>n.analysisStatus==="index_reference"||n.validationStatus==="index_reference").length,pendingCount:e.filter(n=>n.analysisStatus!=="analyzed"&&n.analysisStatus!=="index_reference").length,totalCount:e.length}}function he(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function Ge(e){const a=new Set;for(const n of e)for(const r of he(n.tags))a.add(r);return[...a].sort((n,r)=>n.localeCompare(r))}const H=[],ge=fe(H);Ie(ge,H);const ve=["pe","pb","debtRatio","currentRatio","fcf"];function O(e){return Z(ie({sector:e.sector,industry:e.industry,sicCode:e.sicCode}))}function x(e){const a=new Set(O(e).omit||[]);return a.has("current")&&a.has("debt")}function C(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function Ee(e,a=e.price){if(!Re(e))return null;const n=e.price/e.pe,r=e.hasNegativeEquity===!0,o=r?null:e.pb?e.price/e.pb:null,i=a/n,t=o!==null&&o>0?a/o:null,l=i!==null&&t!==null?i*t:null,s=z(n,o),c=n*20,M=o!==null&&o>0?o*2:null,d=j({grahamFormula:s,pricePe20:c,pricePb2:M});return{pe:i,pb:t,pePb:l,hasNegativeEquity:r||null,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:e.epsGrowing??null,roe:e.roe??null,roa:e.roa??null,tie:e.tie??null,epsAdj:n,bvps:o,price:a,grahamFormula:s,pricePe20:c,pricePb2:M,maxDefensivePrice:d,distanceToDefensive:d>0?(a-d)/d:null,marginOfSafety:Q(s,a)}}function Re(e){return e.hasNegativeEquity?C(e.price)&&C(e.pe)&&C(e.currentRatio):[e.price,e.pe,e.pb].every(C)?x(e)?!0:C(e.debtRatio)&&C(e.currentRatio):!1}function Te(e){return e.hasNegativeEquity?["pe","currentRatio","fcf"].filter(a=>C(e[a])).length:ve.filter(a=>C(e[a])).length}function Xe(e,a=null,n=L){const r=(a==null?void 0:a.price)??e.lastPrice??e.price;if(be(e))return f({...e,quote:a,livePrice:r??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});const o=Te(e),i=x(e)?2:3;if(o<i)return e.validationStatus==="yahoo_model_rejected"?f({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Rechazada por modelo Graham defensivo con datos parciales no comparables."},alertLevel:"watch",alertLabel:e.classificationLabel||"Rechazada por modelo",closeToDefensive:!1,near:!1}):f({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const t=Ee(e,r);if(!t)return e.analysisStatus==="analyzed"?f({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?f({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):f({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const l=O(e),s=ee(t,l),c=new Set(l.omit||[]),M=l.useTangibleBook?t.pbTangible:t.pb,d=l.useTangibleBook?t.pePbTangible:t.pePb,S=(w,V,K)=>w||C(V)&&K,X=t.hasNegativeEquity?!1:S(c.has("pePb"),d,d<=n.nearPePb)&&S(c.has("pe"),t.pe,t.pe<=n.nearPe)&&S(c.has("pb"),M,M<=n.nearPb)&&S(c.has("debt"),t.debtRatio,t.debtRatio<n.nearDebtRatio)&&S(c.has("current"),t.currentRatio,t.currentRatio>=n.nearCurrentRatio)&&t.epsAllPositive===!0,b=!t.hasNegativeEquity&&t.distanceToDefensive!==null&&t.distanceToDefensive<=n.grahamDistancePct;let g="watch",E="En observacion";s.id==="graham_approved"?(g="approved",E="Aprobada Graham"):(X||b)&&(g="near",E="Cerca de aprobar");const _=g==="approved"?s.reason:ce(t,l);return f({...e,quote:a,livePrice:r,ratios:t,classification:s,sectorProfileId:l.id,alertLevel:g,alertLabel:E,watchReason:_,closeToDefensive:b,near:X})}function Le(e,a={},n=L){return e.map(r=>Xe(r,a[r.ticker]??null,n)).sort((r,o)=>{const i={approved:0,near:1,watch:2,reference:3,pending:4};return i[r.alertLevel]!==i[o.alertLevel]?i[r.alertLevel]-i[o.alertLevel]:!r.ratios||!o.ratios?r.ticker.localeCompare(o.ticker):r.ratios.pePb-o.ratios.pePb})}function Ue(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function be(e){var a,n;return e.analysisStatus==="index_reference"||e.analysisStatus==="market_reference"||e.validationStatus==="index_reference"||e.validationStatus==="market_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||((n=e.tags)==null?void 0:n.includes("market_reference"))||["INDEX","ETF","FUTURE"].includes(String(e.quoteType||"").toUpperCase())}function f(e){return{...e,systemStatus:le(e)}}export{h as D,Fe as M,Z as a,Le as b,ee as c,ie as d,fe as e,Ue as f,z as g,Be as h,Ie as i,Ge as j,Ne as l,he as n,ke as p,De as s};
