...
`.trim();function L(e){return e.split(`
`).map(a=>{const[n,r,o,i,t]=a.split("|");return{rawTicker:n,ticker:n,yahooSymbol:r,companyName:o,sector:i||"Sin sector",industry:t||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:I,validationStatus:"validated_yahoo_mx"}})}function O(e){const a=new Map;for(const n of e){const r=n.ticker.toUpperCase();a.has(r)||a.set(r,n)}return[...a.values()]}const h=L(H),E=O([...v.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:I,priority:"requested"})),...h]),_={sourceDate:I,requestedCount:v.length,bmvSicCount:h.length,totalCount:E.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},X={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function w(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const R=U.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:w(e)})),x=new Map(R.map(e=>[e.ticker.toUpperCase(),e]));function V(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function te(e=fetch,a="/"){try{const n=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!n.ok)throw new Error(`No se pudo cargar companies.json: ${n.status}`);const r=await n.json();return Array.isArray(r)?r.map(V):[]}catch{return[]}}function W(e){const a=new Map;for(const n of e)for(const r of n){const o=r.ticker.toUpperCase();a.set(o,{...a.get(o)||{},...r})}return[...a.values()]}function K(e=[]){const a=W([E,e]),n=a.map(i=>{var p,M,d,l;const t=x.get(i.ticker.toUpperCase());return t?{...i,...t,yahooSymbol:t.yahooSymbol||t.ticker,market:t.market||"US",validationStatus:i.validationStatus||"manual_snapshot"}:i.analysisStatus==="analyzed"?{...i,yahooSymbol:i.yahooSymbol||i.ticker,market:i.market||"US",watchReason:i.watchReason||i.notes||"Analisis Graham automatico desde export publico.",tags:(p=i.tags)!=null&&p.length?i.tags:["sec-auto-analysis"]}:String(i.analysisStatus||"").startsWith("analysis_")?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"No se pudo completar el analisis automatico.",tags:(M=i.tags)!=null&&M.length?i.tags:["analysis-review"]}:i.analysisStatus==="index_reference"||i.validationStatus==="index_reference"||(d=i.tags)!=null&&d.includes("index_reference")?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(l=i.tags)!=null&&l.length?i.tags:["index_reference"]}:{...i,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[i.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),r=new Set(a.map(i=>i.ticker.toUpperCase())),o=R.filter(i=>!r.has(i.ticker.toUpperCase()));return[...n,...o]}function q(e,a=[]){return{..._,publicExportCount:a.length,analyzedCount:e.filter(n=>n.analysisStatus==="analyzed").length,referenceCount:e.filter(n=>n.analysisStatus==="index_reference"||n.validationStatus==="index_reference").length,pendingCount:e.filter(n=>n.analysisStatus!=="analyzed"&&n.analysisStatus!=="index_reference").length,totalCount:e.length}}function z(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function se(e){const a=new Set;for(const n of e)for(const r of z(n.tags))a.add(r);return[...a].sort((n,r)=>n.localeCompare(r))}const T=[],Y=K(T);q(Y,T);const j=["pe","pb","debtRatio","currentRatio","fcf"];function A(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function Q(e,a=e.price){if(!J(e))return null;const n=e.price/e.pe,r=e.price/e.pb,o=a/n,i=a/r,t=o*i,p=Math.sqrt(22.5*n*r),M=n*20,d=r*2,l=Math.min(p,M,d);return{pe:o,pb:i,pePb:t,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:null,roe:null,roa:null,tie:null,epsAdj:n,bvps:r,price:a,grahamFormula:p,pricePe20:M,pricePb2:d,maxDefensivePrice:l,distanceToDefensive:l>0?(a-l)/l:null,marginOfSafety:a>0?(p-a)/a:null}}function J(e){return[e.price,e.pe,e.pb,e.debtRatio,e.currentRatio].every(A)}function Z(e){return j.filter(a=>A(e[a])).length}function $(e,a=null,n=X){const r=(a==null?void 0:a.price)??e.lastPrice??e.price;if(ee(e))return m({...e,quote:a,livePrice:r??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});if(Z(e)<3)return m({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const i=Q(e,r);if(!i)return e.analysisStatus==="analyzed"?m({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?m({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):m({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const t=N(i),p=i.pePb<=n.nearPePb&&i.pe<=n.nearPe&&i.pb<=n.nearPb&&i.debtRatio<n.nearDebtRatio&&i.currentRatio>=n.nearCurrentRatio&&i.epsAllPositive===!0,M=i.distanceToDefensive!==null&&i.distanceToDefensive<=n.grahamDistancePct;let d="watch",l="En observacion";return t.id==="graham_approved"?(d="approved",l="Aprobada Graham"):(p||M)&&(d="near",l="Cerca de aprobar"),m({...e,quote:a,livePrice:r,ratios:i,classification:t,alertLevel:d,alertLabel:l,closeToDefensive:M,near:p})}function ce(e,a={},n=X){return e.map(r=>$(r,a[r.ticker]??null,n)).sort((r,o)=>{const i={approved:0,near:1,watch:2,reference:3,pending:4};return i[r.alertLevel]!==i[o.alertLevel]?i[r.alertLevel]-i[o.alertLevel]:!r.ratios||!o.ratios?r.ticker.localeCompare(o.ticker):r.ratios.pePb-o.ratios.pePb})}function le(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function ee(e){var a;return e.analysisStatus==="index_reference"||e.validationStatus==="index_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||["INDEX","ETF"].includes(String(e.quoteType||"").toUpperCase())}function m(e){return{...e,systemStatus:G(e)}}export{re as M,le as a,K as b,N as c,q as d,se as e,te as f,oe as l,z as n,ce as s};
