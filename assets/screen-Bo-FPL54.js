...
`).map(a=>{const[r,i,o,n,t]=a.split("|");return{rawTicker:r,ticker:r,yahooSymbol:i,companyName:o,sector:n||"Sin sector",industry:t||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:b,validationStatus:"validated_yahoo_mx"}})}function me(e){const a=new Map;for(const r of e){const i=r.ticker.toUpperCase();a.has(i)||a.set(i,r)}return[...a.values()]}const U=pe(de),G=me([...B.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:b,priority:"requested"})),...U]),R={sourceDate:b,requestedCount:B.length,bmvSicCount:U.length,totalCount:G.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},L={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function ye(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const _=se.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:ye(e)})),Me=new Map(_.map(e=>[e.ticker.toUpperCase(),e]));function Se(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function Be(e=fetch,a="/"){try{const r=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!r.ok)throw new Error(`No se pudo cargar companies.json: ${r.status}`);const i=await r.json();return Array.isArray(i)?i.map(Se):[]}catch{return[]}}function Ce(e){const a=new Map;for(const r of e)for(const i of r){const o=i.ticker.toUpperCase();a.set(o,{...a.get(o)||{},...i})}return[...a.values()]}function he(e=[]){const a=Ce([G,e]),r=a.map(n=>{var l,s,c,m,p;const t=Me.get(n.ticker.toUpperCase());return t?{...n,...t,yahooSymbol:t.yahooSymbol||t.ticker,market:t.market||"US",validationStatus:n.validationStatus||"manual_snapshot"}:n.analysisStatus==="analyzed"?{...n,yahooSymbol:n.yahooSymbol||n.ticker,market:n.market||"US",watchReason:n.watchReason||n.notes||"Analisis Graham automatico desde export publico.",tags:(l=n.tags)!=null&&l.length?n.tags:["sec-auto-analysis"]}:String(n.analysisStatus||"").startsWith("analysis_")?{...n,yahooSymbol:n.yahooSymbol||n.ticker,watchReason:n.watchReason||n.notes||"No se pudo completar el analisis automatico.",tags:(s=n.tags)!=null&&s.length?n.tags:["analysis-review"]}:n.analysisStatus==="index_reference"||n.analysisStatus==="market_reference"||n.validationStatus==="index_reference"||n.validationStatus==="market_reference"||(c=n.tags)!=null&&c.includes("index_reference")||(m=n.tags)!=null&&m.includes("market_reference")||["INDEX","ETF","FUTURE"].includes(String(n.quoteType||"").toUpperCase())?{...n,yahooSymbol:n.yahooSymbol||n.ticker,watchReason:n.watchReason||n.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(p=n.tags)!=null&&p.length?n.tags:["market_reference"]}:{...n,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[n.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),i=new Set(a.map(n=>n.ticker.toUpperCase())),o=_.filter(n=>!i.has(n.ticker.toUpperCase()));return[...r,...o]}function ge(e,a=[]){const r=a.map(i=>i.lastPriceUpdatedAt||i.lastPriceDate||i.sourceDate).filter(Boolean).sort((i,o)=>String(o).localeCompare(String(i)))[0]||R.sourceDate;return{...R,publicExportCount:a.length,analyzedCount:e.filter(i=>i.analysisStatus==="analyzed").length,referenceCount:e.filter(i=>i.analysisStatus==="index_reference"||i.analysisStatus==="market_reference"||i.validationStatus==="index_reference"||i.validationStatus==="market_reference"||["INDEX","ETF","FUTURE"].includes(String(i.quoteType||"").toUpperCase())).length,pendingCount:e.filter(i=>i.analysisStatus!=="analyzed"&&i.analysisStatus!=="index_reference"&&i.analysisStatus!=="market_reference"&&i.validationStatus!=="index_reference"&&i.validationStatus!=="market_reference").length,totalCount:e.length,dataUpdatedAt:r}}function Ie(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function Ue(e){const a=new Set;for(const r of e)for(const i of Ie(r.tags))a.add(i);return[...a].sort((r,i)=>r.localeCompare(i))}function Ge(e){const a=new Set;for(const r of e){const i=String(r.sector||"").trim();i&&a.add(i)}return[...a].sort((r,i)=>r.localeCompare(i))}const H=[],fe=he(H);ge(fe,H);const Te=["pe","pb","debtRatio","currentRatio","fcf"];function w(e){return $(ne({sector:e.sector,industry:e.industry,sicCode:e.sicCode}))}function x(e){const a=new Set(w(e).omit||[]);return a.has("current")&&a.has("debt")}function M(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function ve(e,a=e.price){if(!Ee(e))return null;const r=e.price/e.pe,i=e.hasNegativeEquity===!0,o=i?null:e.pb?e.price/e.pb:null,n=a/r,t=o!==null&&o>0?a/o:null,l=n!==null&&t!==null?n*t:null,s=z(r,o),c=r*20,m=o!==null&&o>0?o*2:null,p=j({grahamFormula:s,pricePe20:c,pricePb2:m});return{pe:n,pb:t,pePb:l,hasNegativeEquity:i||null,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:e.epsGrowing??null,roe:e.roe??null,roa:e.roa??null,tie:e.tie??null,epsAdj:r,bvps:o,price:a,grahamFormula:s,pricePe20:c,pricePb2:m,maxDefensivePrice:p,distanceToDefensive:p>0?(a-p)/p:null,marginOfSafety:J(s,a)}}function Ee(e){return e.hasNegativeEquity?M(e.price)&&M(e.pe)&&M(e.currentRatio):[e.price,e.pe,e.pb].every(M)?x(e)?!0:M(e.debtRatio)&&M(e.currentRatio):!1}function be(e){return e.hasNegativeEquity?["pe","currentRatio","fcf"].filter(a=>M(e[a])).length:Te.filter(a=>M(e[a])).length}function Xe(e,a=null,r=L){const i=(a==null?void 0:a.price)??e.lastPrice??e.price;if(Ae(e))return h({...e,quote:a,livePrice:i??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});const o=be(e),n=x(e)?2:3;if(o<n)return e.validationStatus==="yahoo_model_rejected"?h({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Rechazada por modelo Graham defensivo con datos parciales no comparables."},alertLevel:"watch",alertLabel:e.classificationLabel||"Rechazada por modelo",closeToDefensive:!1,near:!1}):h({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const t=ve(e,i);if(!t)return e.analysisStatus==="analyzed"?h({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?h({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):h({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const l=w(e),s=ae(t,l),c=new Set(l.omit||[]),m=l.useTangibleBook?t.pbTangible:t.pb,p=l.useTangibleBook?t.pePbTangible:t.pePb,S=(q,V,Y)=>q||M(V)&&Y,X=t.hasNegativeEquity?!1:S(c.has("pePb"),p,p<=r.nearPePb)&&S(c.has("pe"),t.pe,t.pe<=r.nearPe)&&S(c.has("pb"),m,m<=r.nearPb)&&S(c.has("debt"),t.debtRatio,t.debtRatio<r.nearDebtRatio)&&S(c.has("current"),t.currentRatio,t.currentRatio>=r.nearCurrentRatio)&&t.epsAllPositive===!0,A=!t.hasNegativeEquity&&t.distanceToDefensive!==null&&t.distanceToDefensive<=r.grahamDistancePct;let f="watch",E="En observacion";s.id==="graham_approved"?(f="approved",E="Aprobada Graham"):(X||A)&&(f="near",E="Cerca de aprobar");const O=f==="approved"?s.reason:le(t,l);return h({...e,quote:a,livePrice:i,ratios:t,classification:s,sectorProfileId:l.id,alertLevel:f,alertLabel:E,watchReason:O,closeToDefensive:A,near:X})}function Le(e,a={},r=L){return e.map(i=>Xe(i,a[i.ticker]??null,r)).sort((i,o)=>{const n={approved:0,near:1,watch:2,reference:3,pending:4};return n[i.alertLevel]!==n[o.alertLevel]?n[i.alertLevel]-n[o.alertLevel]:!i.ratios||!o.ratios?i.ticker.localeCompare(o.ticker):i.ratios.pePb-o.ratios.pePb})}function _e(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function Ae(e){var a,r;return e.analysisStatus==="index_reference"||e.analysisStatus==="market_reference"||e.validationStatus==="index_reference"||e.validationStatus==="market_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||((r=e.tags)==null?void 0:r.includes("market_reference"))||["INDEX","ETF","FUTURE"].includes(String(e.quoteType||"").toUpperCase())}function h(e){return{...e,systemStatus:ue(e)}}export{I as D,Ne as M,$ as a,Le as b,ae as c,ne as d,he as e,_e as f,z as g,Be as h,ge as i,Ue as j,Ge as k,Fe as l,Ie as n,De as p,Re as s};
