...
`.trim();function w(e){return e.split(`
`).map(a=>{const[n,r,o,i,t]=a.split("|");return{rawTicker:n,ticker:n,yahooSymbol:r,companyName:o,sector:i||"Sin sector",industry:t||"Sin industria",quoteType:"EQUITY",market:"BMV SIC",source:"Yahoo Finance Search",sourceDate:v,validationStatus:"validated_yahoo_mx"}})}function x(e){const a=new Map;for(const n of e){const r=n.ticker.toUpperCase();a.has(r)||a.set(r,n)}return[...a.values()]}const T=w(_),A=x([...R.map(e=>({...e,sector:e.sector||"Solicitados",industry:e.industry||e.quoteType,source:"User requested batch + Yahoo Finance Search",sourceDate:v,priority:"requested"})),...T]),V={sourceDate:v,requestedCount:R.length,bmvSicCount:T.length,totalCount:A.length,sources:["Yahoo Finance Search","Grupo BMV Mercado Global/SIC"]},P={nearPePb:28,nearPe:22,nearPb:2.3,nearDebtRatio:1.2,nearCurrentRatio:1.8,grahamDistancePct:.15};function W(e){const a=["manual-candidate"];return e.pePb<=22.5&&e.pe<=20&&e.pb<=2&&a.push("graham-watch"),e.sector&&a.push(String(e.sector).split("/")[0].trim().toLowerCase().replace(/\s+/g,"-")),a}const D=H.map(e=>({...e,analysisStatus:"analyzed",yahooSymbol:e.yahooSymbol||e.ticker,market:e.market||"US",watchReason:e.note,tags:W(e)})),K=new Map(D.map(e=>[e.ticker.toUpperCase(),e]));function q(e){return{...e,yahooSymbol:e.yahooSymbol||e.yahoo_symbol||e.ticker,companyName:e.companyName||e.company_name||e.name||e.ticker,quoteType:e.quoteType||e.quote_type||"EQUITY",analysisStatus:e.analysisStatus||e.analysis_status||"pending_fundamentals",validationStatus:e.validationStatus||e.validation_status||"needs_manual_review",sourceDate:e.sourceDate||e.source_date,notes:e.notes||e.note||""}}async function le(e=fetch,a="/"){try{const n=await e(`${a.replace(/\/?$/,"/")}data/companies.json`);if(!n.ok)throw new Error(`No se pudo cargar companies.json: ${n.status}`);const r=await n.json();return Array.isArray(r)?r.map(q):[]}catch{return[]}}function Y(e){const a=new Map;for(const n of e)for(const r of n){const o=r.ticker.toUpperCase();a.set(o,{...a.get(o)||{},...r})}return[...a.values()]}function z(e=[]){const a=Y([A,e]),n=a.map(i=>{var m,p,d,M,l;const t=K.get(i.ticker.toUpperCase());return t?{...i,...t,yahooSymbol:t.yahooSymbol||t.ticker,market:t.market||"US",validationStatus:i.validationStatus||"manual_snapshot"}:i.analysisStatus==="analyzed"?{...i,yahooSymbol:i.yahooSymbol||i.ticker,market:i.market||"US",watchReason:i.watchReason||i.notes||"Analisis Graham automatico desde export publico.",tags:(m=i.tags)!=null&&m.length?i.tags:["sec-auto-analysis"]}:String(i.analysisStatus||"").startsWith("analysis_")?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"No se pudo completar el analisis automatico.",tags:(p=i.tags)!=null&&p.length?i.tags:["analysis-review"]}:i.analysisStatus==="index_reference"||i.analysisStatus==="market_reference"||i.validationStatus==="index_reference"||i.validationStatus==="market_reference"||(d=i.tags)!=null&&d.includes("index_reference")||(M=i.tags)!=null&&M.includes("market_reference")||["INDEX","ETF","FUTURE"].includes(String(i.quoteType||"").toUpperCase())?{...i,yahooSymbol:i.yahooSymbol||i.ticker,watchReason:i.watchReason||i.notes||"Referencia de mercado. No requiere analisis Graham.",tags:(l=i.tags)!=null&&l.length?i.tags:["market_reference"]}:{...i,analysisStatus:"pending_fundamentals",watchReason:"Pendiente de primer analisis Graham: requiere fundamentales de Yahoo Finance o captura manual validada.",tags:[i.priority==="requested"?"requested":"bmv-sic","pending-analysis"]}}),r=new Set(a.map(i=>i.ticker.toUpperCase())),o=D.filter(i=>!r.has(i.ticker.toUpperCase()));return[...n,...o]}function Q(e,a=[]){return{...V,publicExportCount:a.length,analyzedCount:e.filter(n=>n.analysisStatus==="analyzed").length,referenceCount:e.filter(n=>n.analysisStatus==="index_reference"||n.validationStatus==="index_reference").length,pendingCount:e.filter(n=>n.analysisStatus!=="analyzed"&&n.analysisStatus!=="index_reference").length,totalCount:e.length}}function j(e){return Array.isArray(e)?e.map(a=>String(a).trim()).filter(Boolean):String(e||"").split(",").map(a=>a.trim()).filter(Boolean)}function ue(e){const a=new Set;for(const n of e)for(const r of j(n.tags))a.add(r);return[...a].sort((n,r)=>n.localeCompare(r))}const b=[],J=z(b);Q(J,b);const Z=["pe","pb","debtRatio","currentRatio","fcf"],$=["Financial Services","Real Estate","Insurance"];function h(e){const a=String(e.sector||"");return $.some(n=>a===n||a.startsWith(n+" /")||a.startsWith(n+"/"))}function C(e){return e!=null&&e!==""&&Number.isFinite(Number(e))}function ee(e,a=e.price){if(!ae(e))return null;const n=e.price/e.pe,r=e.hasNegativeEquity===!0,o=r?null:e.pb?e.price/e.pb:null,i=a/n,t=o!==null&&o>0?a/o:null,m=i!==null&&t!==null?i*t:null,p=n>0&&o!==null&&o>0?Math.sqrt(22.5*n*o):null,d=n*20,M=o!==null&&o>0?o*2:null,l=p!==null&&M!==null?Math.min(p,d,M):d;return{pe:i,pb:t,pePb:m,hasNegativeEquity:r||null,debtRatio:e.debtRatio,currentRatio:e.currentRatio,quickRatio:e.quickRatio,fcf:e.fcf,epsAllPositive:e.epsAllPositive,epsGrowing:e.epsGrowing??null,roe:e.roe??null,roa:e.roa??null,tie:e.tie??null,epsAdj:n,bvps:o,price:a,grahamFormula:p,pricePe20:d,pricePb2:M,maxDefensivePrice:l,distanceToDefensive:l>0?(a-l)/l:null,marginOfSafety:a>0&&p!==null?(p-a)/a:null}}function ae(e){return e.hasNegativeEquity?C(e.price)&&C(e.pe)&&C(e.currentRatio):[e.price,e.pe,e.pb].every(C)?h(e)?!0:C(e.debtRatio)&&C(e.currentRatio):!1}function ne(e){return e.hasNegativeEquity?["pe","currentRatio","fcf"].filter(a=>C(e[a])).length:Z.filter(a=>C(e[a])).length}function ie(e,a=null,n=P){const r=(a==null?void 0:a.price)??e.lastPrice??e.price;if(re(e))return y({...e,quote:a,livePrice:r??null,ratios:null,classification:{id:"index_reference",label:"REFERENCIA",color:"#38bdf8",reason:e.notes||"Instrumento de referencia para comparar mercado; no se analiza con reglas Graham defensivas."},alertLevel:"reference",alertLabel:"Referencia de mercado",closeToDefensive:!1,near:!1});const o=ne(e),i=h(e)?2:3;if(o<i)return e.validationStatus==="yahoo_model_rejected"?y({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Rechazada por modelo Graham defensivo con datos parciales no comparables."},alertLevel:"watch",alertLabel:e.classificationLabel||"Rechazada por modelo",closeToDefensive:!1,near:!1}):y({...e,analysisStatus:"analysis_incomplete",quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:"analysis_incomplete",label:"DATOS INSUFICIENTES",color:"#94a3b8",reason:"Faltan al menos 3 de 5 ratios criticos para evaluar con Graham."},alertLevel:"pending",alertLabel:"Datos insuficientes",closeToDefensive:!1,near:!1});const t=ee(e,r);if(!t)return e.analysisStatus==="analyzed"?y({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.classificationId||"rejected",label:e.classificationLabel||"RECHAZADA",color:"#ef4444",reason:e.notes||"Analizada, pero con datos insuficientes para aprobar reglas Graham."},alertLevel:"watch",alertLabel:e.classificationLabel||"Analizada sin aprobacion Graham",closeToDefensive:!1,near:!1}):String(e.analysisStatus||"").startsWith("analysis_")?y({...e,quote:a,livePrice:(a==null?void 0:a.price)??e.price??null,ratios:null,classification:{id:e.analysisStatus,label:"NO SOPORTADA",color:"#94a3b8",reason:e.notes||"No se pudo completar el analisis automatico."},alertLevel:"pending",alertLabel:e.notes||"No soportada por analisis automatico",closeToDefensive:!1,near:!1}):y({...e,quote:a,livePrice:(a==null?void 0:a.price)??null,ratios:null,classification:{id:"pending_fundamentals",label:"PENDIENTE DE ANALISIS",color:"#94a3b8",reason:"Faltan fundamentales para calcular ratios Graham."},alertLevel:"pending",alertLabel:a!=null&&a.price?"Precio disponible, faltan fundamentales":"Pendiente de primer analisis",closeToDefensive:!1,near:!1});const m=G(t),p=h(e),d=t.hasNegativeEquity?!1:p?t.pePb<=n.nearPePb&&t.pe<=n.nearPe&&t.pb<=n.nearPb&&t.epsAllPositive===!0:t.pePb<=n.nearPePb&&t.pe<=n.nearPe&&t.pb<=n.nearPb&&t.debtRatio<n.nearDebtRatio&&t.currentRatio>=n.nearCurrentRatio&&t.epsAllPositive===!0,M=!t.hasNegativeEquity&&t.distanceToDefensive!==null&&t.distanceToDefensive<=n.grahamDistancePct;let l="watch",f="En observacion";return m.id==="graham_approved"?(l="approved",f="Aprobada Graham"):(d||M)&&(l="near",f="Cerca de aprobar"),y({...e,quote:a,livePrice:r,ratios:t,classification:m,alertLevel:l,alertLabel:f,closeToDefensive:M,near:d})}function pe(e,a={},n=P){return e.map(r=>ie(r,a[r.ticker]??null,n)).sort((r,o)=>{const i={approved:0,near:1,watch:2,reference:3,pending:4};return i[r.alertLevel]!==i[o.alertLevel]?i[r.alertLevel]-i[o.alertLevel]:!r.ratios||!o.ratios?r.ticker.localeCompare(o.ticker):r.ratios.pePb-o.ratios.pePb})}function de(e){return{approved:e.filter(a=>a.alertLevel==="approved"),near:e.filter(a=>a.alertLevel==="near"),watch:e.filter(a=>a.alertLevel==="watch"),reference:e.filter(a=>a.alertLevel==="reference"),pending:e.filter(a=>a.alertLevel==="pending")}}function re(e){var a,n;return e.analysisStatus==="index_reference"||e.analysisStatus==="market_reference"||e.validationStatus==="index_reference"||e.validationStatus==="market_reference"||((a=e.tags)==null?void 0:a.includes("index_reference"))||((n=e.tags)==null?void 0:n.includes("market_reference"))||["INDEX","ETF","FUTURE"].includes(String(e.quoteType||"").toUpperCase())}function y(e){return{...e,systemStatus:O(e)}}export{se as M,de as a,z as b,G as c,Q as d,ue as e,le as f,ce as l,j as n,pe as s};
